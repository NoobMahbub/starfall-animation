...
const appendElement = (element: HTMLElement): void => document.body.appendChild(element),
      removeElement = (element: HTMLElement, delay: number): void => setTimeout(() => document.body.removeChild(element), delay);
...
const updateLastMousePosition = (position: Position): void => last.mousePosition = position;
...
document.body.onmouseleave = (): void => updateLastMousePosition(originPosition);
